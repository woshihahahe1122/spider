...
const ma = document.createElement(mO['BluetoothD']);// 尝试动态创建元素
...
function mq(Qf, Qz, QI, Qq) {
    ...
    var  Qz, QI = ma;
    var  QG, Qk;
    if (QG = Qq || mO['xqqfh'](mH),
    mO['QWlqU'](mO['xyDux'], typeof QI)) {
        var Qv = new Date();
        Qv['setTime'](mO['CuLbd'](Qv['getTime'](), QI)),
        Qk = Qv['toGMTStrin' + 'g']();
    } else
        Qk = QI;
    ma['cookie'] = mO['VlNuj'](mO['prXwD'](mO['MBwMA'](mO['gUehI'](mO['MBwMA'](mO['jlkiO'](Qf, '='), Qz), mO['QISrS']), Qk), mO['VsVHn']), QG);
    return ma['cookie'];
}
...
a  =  "ssxmod_itna"
b  =  "Yq+x9DuQi=YGu4eKxmqBIYDIAPPxnDQKGHDyxWKG7DuxiK08D6QDB446TMYhawpcvGWFDOytDlr72YDSxD67DK4GTw+Z2rI1KjmOhb4o57h4h1WKmoOIjo1lgBiBfaHoZS99Lvr2AxwDB3DbqDySMGrDYAEDBYD74G+DDeDiO3Dj4GmDGAQTeDFmeTtZWbKNxDwDB=DmdmTmeDEDG3D0bRNR0GQfQqD0dwGu7D5C7DDbrR=PmcT4xDSi7T4YibDjkPD/8hjgPDBnIMQ41TEE/Bw7WaaxBQD7q9QoQe8fCntTl7VGkGNKrd+=+PmeeiD5ihChDqBXCci/GDjQ+U7G2QG1gNuApQt4DDcV/AF/isWHMGvmm5ZKhqjb7AurAuYiGPjAHQGqYwrBhND+i9PPeYPA04vg4/qDEGDD"
c  =  new Date(mO[aX(y3.m5)](new Date()[aX(y3.m4)](), -0x8b8cd + 0x1a1611 + -0x74 * -0x164b))[aX(y3.m6) + 'g']()
d  =  "ctbpsp.com"

console.log(b.length)
ssxmod_itna  =  mq(a,b,c,d)
console.log(ssxmod_itna)